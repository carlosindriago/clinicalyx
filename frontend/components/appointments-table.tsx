                  ...
                  <TableCell className="px-6 py-4 text-right">
                    <DropdownMenu>
                      ...
                      >
                        ...
                        >
                          <PlayCircle className="size-4 text-teal-600 dark:text-teal-300" aria-hidden="true" />
                          Iniciar Consulta
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          disabled={isCancelled}
                          ...
                          className="rounded-lg px-2.5 py-2 text-sm text-slate-700 hover:bg-slate-50 focus:bg-slate-50 disabled:opacity-50 dark:text-slate-200 dark:hover:bg-slate-800/60 dark:focus:bg-slate-800/60"
                        >
                          <RefreshCcw className="size-4 text-teal-600 dark:text-teal-300" aria-hidden="true" />
                          Reprogramar
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          disabled={isCancelled}
